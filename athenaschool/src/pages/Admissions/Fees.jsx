...
function Fees() {
  ...
  const calculateDiscountedPrice = (basePrice) => selectedPayment === 'annual' ? Math.round(basePrice * 0.95) : basePrice;
            ...
            <div className="grid grid-cols-3 md:grid-cols-5 gap-2">
              {grades.map((grade) => (
                <button
                  ...
                  className={`py-4 font-bold text-xs uppercase tracking-widest border transition-all ${
