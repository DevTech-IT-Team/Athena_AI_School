        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16">
            ...
            <p className="text-center text-blue-700 mb-12 max-w-3xl mx-auto">
              Our registration process is designed to make joining WisdomAI School seamless and exciting for both learners and parents.
            </p>
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-grow">
                  <h3 className="text-xl font-semibold mb-2 text-blue-900">Setting Up the WisdomAI Learning Platform</h3>
                  <p className="text-blue-700">
                    After payment, set up your personalised WisdomAI Learning Platform, designed to make learning 
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-blue-700">
                    Your child is now ready to embark on their educational journey with WisdomAI School. Happy learning!
                  </p>
                </div>
              </div>
            </div>
