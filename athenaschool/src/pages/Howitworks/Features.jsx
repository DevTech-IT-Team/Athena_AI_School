      ...
      <div className="bg-gradient-to-r from-blue-100 to-blue-200 text-gray-800 py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">A day in the life of WisdomAI School+ Stride - American Curriculum student</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <p className="text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto">
              WisdomAI School will conduct the classes online along with the following elements of the online program. All these activities / features will be online on our learning platform.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-100 to-blue-200 text-gray-800 rounded-xl p-12 text-center">
            ...
            <p className="text-lg mb-8">Join WisdomAI School and discover a world of interactive learning possibilities</p>
            <div className="flex flex-wrap gap-4 justify-center">
              <button className="bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                Enquire Now
              </button>
