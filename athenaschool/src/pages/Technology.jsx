      ...
      <div className="bg-gradient-to-r from-blue-100 to-blue-200 text-gray-800 py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">Discover Personalised Learning at 21K School</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <p className="text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto">
              21K School Program is delivered in a secured way with end-to-end encryption of all live sessions and chat. Each Learner / Parent has a unique ID and Password. Learners can connect from anywhere, any device at a time and place convenient to them.
            </p>
          </div>
          ...
          <div className="bg-gray-100 rounded-xl p-8 mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-semibold mb-2">21K Video - Virtual Classes</h3>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-semibold mb-2">21K Learning Portal Homework Module</h3>
                <p className="text-gray-600 text-sm mb-2">#Being21K</p>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-semibold mb-2">21K Learning Portal - Schedule</h3>
                <p className="text-gray-600 text-sm mb-2">#Being21K</p>
